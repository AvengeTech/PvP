...
use pvp\PvP;
use pvp\enchantments\Enchantments;
use pvp\enchantments\effects\commands\{
	AddEffect,
};
...
class Effects{
	...
	public function __construct(PvP $plugin, Enchantments $enchantments){
		$this->plugin = $plugin;
		...
		/**for($i=0; $i<=4; $i++){
			ItemFactory::getInstance()->register(new EffectItem($i), true);
		}*/
	}
